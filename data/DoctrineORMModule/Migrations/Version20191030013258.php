 ...
 */
final class Version20191030013258 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oauth_users DROP Empresa_id, DROP Contabilidade_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Empresa ADD CONSTRAINT FK_776A63CC66E5D40B FOREIGN KEY (Contabilidade_id) REFERENCES Contabilidade (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE oauth_users ADD Empresa_id INT DEFAULT NULL, ADD Contabilidade_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE oauth_users ADD CONSTRAINT FK_93804FF866E5D40B FOREIGN KEY (Contabilidade_id) REFERENCES Contabilidade (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
