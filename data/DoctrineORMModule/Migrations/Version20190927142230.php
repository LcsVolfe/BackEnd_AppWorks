 ...
 */
final class Version20190927142230 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE oauth_roles_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE oauth_scopes (scope VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, first_name VARCHAR(2000) DEFAULT NULL, client_id VARCHAR(80) DEFAULT NULL, is_default INT NOT NULL, PRIMARY KEY(scope))');
        ...
        $this->addSql('CREATE TABLE oauth_users (id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(2000) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, Role_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_93804FF819BE1B30 ON oauth_users (Role_id)');
        $this->addSql('CREATE TABLE oauth_roles (id INT NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE oauth_access_tokens (access_token VARCHAR(40) NOT NULL, client_id VARCHAR(80) NOT NULL, user_id VARCHAR(255) NOT NULL, expires TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, scope VARCHAR(2000) DEFAULT NULL, PRIMARY KEY(access_token))');
        ...
        $this->addSql('ALTER TABLE oauth_users ADD CONSTRAINT FK_93804FF819BE1B30 FOREIGN KEY (Role_id) REFERENCES oauth_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oauth_users DROP CONSTRAINT FK_93804FF819BE1B30');
        $this->addSql('DROP SEQUENCE oauth_users_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE oauth_roles_id_seq CASCADE');
