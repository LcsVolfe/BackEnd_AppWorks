 ...
 */
final class Version20191112024133 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_93804FF8D60322AC ON oauth_users');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oauth_users ADD CONSTRAINT FK_93804FF819BE1B30 FOREIGN KEY (Role_id) REFERENCES oauth_roles (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_93804FF8D60322AC ON oauth_users (Role_id)');
    }
}
